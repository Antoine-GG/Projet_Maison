 ...
 * Le Master envoi le code 0x25 au slave pour lui dire qu'il doit lui envoyer l'état des bouton poussoirs relié sur PC2, Pc1 et PC0 (capteur PORTE, FENETRE 1, FENETRE 2) et lit la température fournie par le DS1621
...
int main()
{
	...
	while (1)
	{
		...
		_delay_ms(5);
		val=I2C_Read_Nack();							//Lire la donnée (1 seule) et envoyer sur le port D
		/*Temoin Porte*/
		if ((val & 0b00000001)==0b00000000)
		{
			PORTC &=~(1<<PC0);
